      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="card bg-base-100 shadow-xl border-2 border-primary max-w-2xl mx-auto">
          <div className="card-body text-center p-8">
            ...
            <p className="text-lg text-base-content/70 mb-6">{plan.description}</p>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center justify-center space-x-4">
                ...
                <div className="text-2xl">🍎</div>
                <div className="text-2xl">📱</div>
                <div className="text-sm text-base-content/60">+ more</div>
              </div>
            </div>
      ...
      <div className="bg-base-200 py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-2">What subjects are included?</h3>
